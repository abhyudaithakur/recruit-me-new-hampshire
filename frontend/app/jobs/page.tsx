          ...
          <tbody>
            {paginatedJobs.length === 0 ? (
              <tr>
                <td
                  colSpan={5}
                  className="text-center p-4 border border-black text-gray-600"
                >
                  No jobs found.
                </td>
              </tr>
              ...
              paginatedJobs.map((job: j) => (
                <tr key={job.jobId}>
                  ...
                  <td className="p-3 border border-black text-sm font-semibold">
                    {job.status}
                  </td>
                  ...
                  <td className="p-3 border border-black text-center">
                    <button
                      onClick={() =>
                        router.push(`/jobs/view?jobId=${job.jobId}`)
                      }
